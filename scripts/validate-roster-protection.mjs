...
console.log('\n=== 7. Real data/season.js wiring: season 1 bootstrap + season transition ===\n');
{
  ...
  assert(state1.schemaVersion === STATE_SCHEMA_VERSION && STATE_SCHEMA_VERSION === 13, `schemaVersion is the current STATE_SCHEMA_VERSION, 13 (got ${state1.schemaVersion})`);
