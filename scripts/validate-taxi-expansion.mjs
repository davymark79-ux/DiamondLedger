...
console.log('\n=== 8. Real data/season.js wiring: season-1 bootstrap + optionYearsUsed + season transition ===\n');
{
  ...
  assert(state1.schemaVersion === STATE_SCHEMA_VERSION && STATE_SCHEMA_VERSION === 15, `schemaVersion is the current STATE_SCHEMA_VERSION, 15 (got ${state1.schemaVersion})`);
