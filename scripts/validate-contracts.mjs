...
console.log('\n=== 7. Real data/season.js wiring: every player has a contract, season-1 payroll re-derives correctly ===\n');
{
  ...
  assert(state1.schemaVersion === STATE_SCHEMA_VERSION && STATE_SCHEMA_VERSION === 25, `schemaVersion is the current STATE_SCHEMA_VERSION, 25 (got ${state1.schemaVersion})`);
